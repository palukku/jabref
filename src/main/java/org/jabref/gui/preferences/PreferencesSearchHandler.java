...
class PreferencesSearchHandler {
    ...
    PreferencesSearchHandler(List<PreferencesTab> preferenceTabs) {
        ...
        this.preferenceTabsControls = buildPreferenceTabsControls(preferenceTabs);
    ...
    private boolean controlMatchesQuery(Control control, String query) {
        ...
        //TODO: add other control elements to check for query match
     ...
     */
    private ArrayListMultimap<PreferencesTab, Control> buildPreferenceTabsControls(List<PreferencesTab> tabs) {
